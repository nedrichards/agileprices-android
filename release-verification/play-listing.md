...
chosen run time and the next half-hour prices directly on your device.
...
horizon to find a practical start time for appliances, charging and other
...
1. Current Agile price and cheapest run-time window on your watch.
...
run-time window search, cached rates, Tile support and SHORT_TEXT complication
support.
